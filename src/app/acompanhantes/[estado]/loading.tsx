...
export default function StateDirectoryLoading() {
  return (
    <div className="container" style={{ padding: '2rem 1rem 4rem 1rem', maxWidth: '1400px' }}>
      ...
      <Skeleton width="360px" height="36px" style={{ marginBottom: '0.5rem' }} />
      <Skeleton width="540px" height="16px" style={{ marginBottom: '2rem' }} />
