  ...
  async getMetadata(): Promise<PaymentProviderMetadata> {
    ...
    return {
      ...
      mcc_classification: {
        ...
        notes: 'Pendente de envio formal do dossiê em inglês.',
      },
      approval_evidence: {
      ...
      external_actions: [
        { id: 'act_ad_1', action: 'Envio de Dossiê em Inglês para Global Sales Adyen', owner: 'Payments Architect', status: 'pending', notes: 'Preparar documentação de Age Assurance e RevenueAccelerate.' },
      ],
