...
export class AsaasPaymentProvider implements PaymentProvider {
  ...
  async getMetadata(): Promise<PaymentProviderMetadata> {
    ...
    return {
      ...
      external_actions: [
        { id: 'act_as_1', action: 'Envio de Proposta Comercial Asaas', owner: 'Compliance Lead', status: 'pending', notes: 'Consultar automação de PIX recorrente e termos de intermediação 18+.' },
      ],
